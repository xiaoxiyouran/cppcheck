...
#else
        // 这个地方，由于 windows 下，MINGW没有这个宏， 所以用 FindExInfoStandard 代替
    #ifdef WINAPI
        HANDLE hFind = FindFirstFileExA(f.c_str(), FindExInfoStandard, &FindFileData, FindExSearchNameMatch, NULL, 0);
    #else
