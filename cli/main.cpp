...
// C:\Users\xixie\Downloads\cppcheck-1.88\cli\main.cpp
#ifdef _WIN32
    #include <windows.h>
...
int main(int argc, char* argv[])
{
    ...
    startTime = clock();
    std::cout << "Begin to exe at" << startTime << std::endl;
    ...
    printf("Total Time%ld : %ld : %ld \n", lElapseHourTime, lElapseMinuteTime, lElapseSecTime);
    return  iRet;
}
